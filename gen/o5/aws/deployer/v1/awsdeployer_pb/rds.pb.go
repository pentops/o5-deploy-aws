...
var file_o5_aws_deployer_v1_rds_proto_goTypes = []any{
...
func file_o5_aws_deployer_v1_rds_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_o5_aws_deployer_v1_rds_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_o5_aws_deployer_v1_rds_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_o5_aws_deployer_v1_rds_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_o5_aws_deployer_v1_rds_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_o5_aws_deployer_v1_rds_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_o5_aws_deployer_v1_rds_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_o5_aws_deployer_v1_rds_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_o5_aws_deployer_v1_rds_proto_msgTypes[7].Exporter = func(v any, i int) any {
	...
	file_o5_aws_deployer_v1_rds_proto_msgTypes[1].OneofWrappers = []any{
		(*RDSAppSpecType_AppSecret)(nil),
		(*RDSAppSpecType_AppConn)(nil),
	}
	file_o5_aws_deployer_v1_rds_proto_msgTypes[2].OneofWrappers = []any{
