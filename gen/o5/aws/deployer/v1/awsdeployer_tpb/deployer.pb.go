...
var file_o5_aws_deployer_v1_topic_deployer_proto_goTypes = []any{
...
func file_o5_aws_deployer_v1_topic_deployer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_o5_aws_deployer_v1_topic_deployer_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_o5_aws_deployer_v1_topic_deployer_proto_msgTypes[1].Exporter = func(v any, i int) any {
