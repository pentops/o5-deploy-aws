...
var file_o5_aws_deployer_v1_events_deployer_event_proto_goTypes = []any{
...
func file_o5_aws_deployer_v1_events_deployer_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_o5_aws_deployer_v1_events_deployer_event_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_o5_aws_deployer_v1_events_deployer_event_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_o5_aws_deployer_v1_events_deployer_event_proto_msgTypes[2].Exporter = func(v any, i int) any {
