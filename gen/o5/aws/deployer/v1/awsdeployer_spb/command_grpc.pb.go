...
func (c *deploymentCommandServiceClient) TriggerDeployment(ctx context.Context, in *TriggerDeploymentRequest, opts ...grpc.CallOption) (*TriggerDeploymentResponse, error) {
	...
	err := c.cc.Invoke(ctx, DeploymentCommandService_TriggerDeployment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deploymentCommandServiceClient) TerminateDeployment(ctx context.Context, in *TerminateDeploymentRequest, opts ...grpc.CallOption) (*TerminateDeploymentResponse, error) {
	...
	err := c.cc.Invoke(ctx, DeploymentCommandService_TerminateDeployment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deploymentCommandServiceClient) UpsertCluster(ctx context.Context, in *UpsertClusterRequest, opts ...grpc.CallOption) (*UpsertClusterResponse, error) {
	...
	err := c.cc.Invoke(ctx, DeploymentCommandService_UpsertCluster_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deploymentCommandServiceClient) UpsertEnvironment(ctx context.Context, in *UpsertEnvironmentRequest, opts ...grpc.CallOption) (*UpsertEnvironmentResponse, error) {
	...
	err := c.cc.Invoke(ctx, DeploymentCommandService_UpsertEnvironment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deploymentCommandServiceClient) UpsertStack(ctx context.Context, in *UpsertStackRequest, opts ...grpc.CallOption) (*UpsertStackResponse, error) {
	...
	err := c.cc.Invoke(ctx, DeploymentCommandService_UpsertStack_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deploymentCommandServiceClient) SetClusterOverride(ctx context.Context, in *SetClusterOverrideRequest, opts ...grpc.CallOption) (*SetClusterOverrideResponse, error) {
	...
	err := c.cc.Invoke(ctx, DeploymentCommandService_SetClusterOverride_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
